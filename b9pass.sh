#!/usr/bin/env bash
#-Metadata----------------------------------------------------#
#  Filename: b9pass (v1.0.0)             (Update: 2021-11-04) #
#-Info--------------------------------------------------------#
#  Bash Script for bypass 403/401                             #
#-Author(s)---------------------------------------------------#
...
goBanner(){
echo -e "\n"
echo -e ${SORANGE}"___.   ________                             ${SPURPLE}           :::::::  ";
echo -e ${SORANGE}"\_ |__/   __   \___________    ______ ______ ${SPURPLE}         -%%%%%%%-  ";
echo -e ${SORANGE}" | __ \____    /\____ \__  \  /  ___//  ___/${SPURPLE}        ###%%%%%%%###.";
echo -e ${SORANGE}" | \_\ \ /    / |  |_> > __ \_\___ \ \___ \ ${SPURPLE}       .%%*==%%%==*%%.";
echo -e ${SORANGE}" |___  //____/  |   __(____  /____  >____  >${SPURPLE}       .%%*-=%%%=-*%%.";
echo -e ${SORANGE}"     \/         |__|       \/     \/     \/${SPURPLE}        .##%%%%%%%%%##.";
